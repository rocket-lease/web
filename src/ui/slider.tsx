...
/**
 * Slider mobile-friendly. Implementa un input range nativo estilizado
 * con marcas visuales del valor actual y un track con fill brand.
 *
 * No depende de radix — pensado para inputs simples (porcentaje, escalas)
 * donde el comportamiento nativo alcanza y maximiza compatibilidad móvil.
 */
      ...
      <div className={cn('relative w-full py-2', className)}>
        ...
        <input
          ...
          className={cn(
            ...
            '[&::-moz-range-thumb]:h-5 [&::-moz-range-thumb]:w-5 [&::-moz-range-thumb]:rounded-full [&::-moz-range-thumb]:bg-brand-500 [&::-moz-range-thumb]:border-2 [&::-moz-range-thumb]:border-white',
