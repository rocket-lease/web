...
export const reservarApi = {
  ...
  async listMine(): Promise<ListMyReservationsResponse> {
    const res = await apiClient.get<unknown>('/reservations/mine')
    return ListMyReservationsResponseSchema.parse(res)
  },
