      ...
      <div className="flex items-start justify-between gap-3 rounded-xl border border-white/8 bg-surface-2 px-4 py-3">
        <div className="min-w-0 flex-1">
          <div className="flex items-center gap-2">
            ...
            >
              {dynamicPricingEnabled
                ? t('rentador.vehiculo.dynamicPricing.estado.activo')
                : t('rentador.vehiculo.dynamicPricing.estado.inactivo')}
            </span>
          </div>
          <p className="mt-1 flex items-start gap-1.5 text-xs text-text-muted">
            ...
            <span>
              {dynamicPricingEnabled
                ? t('rentador.vehiculo.dynamicPricing.activoHint')
                : t('rentador.vehiculo.dynamicPricing.inactivoHint')}
            </span>
          </p>
        </div>
        <Switch
