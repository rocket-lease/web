...
export function SearchPill({ city, start, end, onClick }: SearchPillProps) {
  ...
  return (
    <button
      onClick={onClick}
      className="w-full flex items-center justify-center gap-2 rounded-full bg-surface-1 border border-white/8 px-5 h-11 hover:border-brand-500/40 transition-colors shadow-sm"
    >
